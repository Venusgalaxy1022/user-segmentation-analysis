...
![매출 트렌드](https://github.com/Venusgalaxy1022/user-segmentation-analysis/blob/main/imgs/sales_data_1.png?raw=true)
...
![상품 및 카테고리 성과](https://github.com/Venusgalaxy1022/user-segmentation-analysis/blob/main/imgs/monthly_orders_by_category.png?raw=true)
...
![구매 고객 특성](https://github.com/Venusgalaxy1022/user-segmentation-analysis/blob/main/imgs/인구학적고객분류에따른판매동향.png?raw=true)
...
![RFM 분석 절차](https://github.com/Venusgalaxy1022/user-segmentation-analysis/blob/main/imgs/rfm_scoring_pipeline.jpg?raw=true)
...
![rfm_distribution](https://github.com/Venusgalaxy1022/user-segmentation-analysis/blob/main/imgs/rfm_distribution.png?raw=true)

정도의 차이는 있지만, 세 지표 모두 관측값이 왼쪽으로 집중된 것을 확인할 수 있다. 즉, 쇼핑몰 대다수의 고객과 달리, 매우 빈번하고 구매력이 큰 소수의 power 고객이 존재한다는 것을 알 수 있다.

![rfm_distribution](https://github.com/Venusgalaxy1022/user-segmentation-analysis/blob/main/imgs/rfm_summary.png?raw=true)
